...
final class LegacySkinDataConverter{
	...
	private const PERSONA_PIECE_TYPES_BARE = [
		...
		"facial_hair" => PersonaSkinPiece::PIECE_TYPE_FACIAL_HAIR,
		...
		"face_accessory" => PersonaSkinPiece::PIECE_TYPE_FACE_ACCESSORY,
		"head" => PersonaSkinPiece::PIECE_TYPE_HEAD,
		"legs" => PersonaSkinPiece::PIECE_TYPE_LEGS,
		"left_leg" => PersonaSkinPiece::PIECE_TYPE_LEFT_LEG,
		"right_leg" => PersonaSkinPiece::PIECE_TYPE_RIGHT_LEG,
		"arms" => PersonaSkinPiece::PIECE_TYPE_ARMS,
		"left_arm" => PersonaSkinPiece::PIECE_TYPE_LEFT_ARM,
		"right_arm" => PersonaSkinPiece::PIECE_TYPE_RIGHT_ARM,
		"capes" => PersonaSkinPiece::PIECE_TYPE_CAPES,
		"classic_skin" => PersonaSkinPiece::PIECE_TYPE_CLASSIC_SKIN,
