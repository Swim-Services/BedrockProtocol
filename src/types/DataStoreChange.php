...
final class DataStoreChange extends DataStore{
	...
	public function __construct(private string $name, private string $property, private int $updateCount, private ?DataStoreValue $data){}
	...
	public static function read(ByteBufferReader $in, int $protocolId) : self{
		...
		$data = DataStoreValue::readWithType($in, $protocolId);
	...
	public function write(ByteBufferWriter $out, int $protocolId) : void{
		...
		DataStoreValue::writeWithType($out, $this->data, $protocolId);
	}
}
