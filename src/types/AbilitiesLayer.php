...
final class AbilitiesLayer{
	...
	private const ABILITY_VERTICAL_FLY_SPEED = 13;
	...
	public static function decode(PacketSerializer $in) : self{
		...
		return new self($layerId, $boolAbilities, $flySpeed, $verticalFlySpeed ?? 0, $walkSpeed);
	}
	...
	public function encode(PacketSerializer $out) : void{
		...
		if($this->verticalFlySpeed !== null && $out->getProtocolId() >= ProtocolInfo::PROTOCOL_1_21_60){
