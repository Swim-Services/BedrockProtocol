...
final class ItemInteractionData{
	...
	public static function read(ByteBufferReader $in, int $protocolId = \pocketmine\network\mcpe\protocol\ProtocolInfo::CURRENT_PROTOCOL) : self{
	...
	public function write(ByteBufferWriter $out, int $protocolId = \pocketmine\network\mcpe\protocol\ProtocolInfo::CURRENT_PROTOCOL) : void{
